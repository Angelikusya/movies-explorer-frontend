        ...
        <section className="about-me">
            ...
            <div className='about-me__description'>
                <div className="about-me__container-about">
                    <h2 className="about-me__name">Анжелика</h2>
                    <h3 className="about-me__profession">Фронтенд-разработчик, молода и перспективна</h3>
                ...
                <img alt="Мое чудесное фото" src={myPhoto} className='about-me__ghoto'/>
            </div>
        </section>
    )
}
